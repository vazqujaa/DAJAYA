...
public class historial extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/logo dajaya1.PNG"))); // NOI18N

        jButton1.setBackground(new java.awt.Color(158, 119, 65));
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/botonRegresar.png"))); // NOI18N
        jButton1.setToolTipText("Regresar a ventas");
        jButton1.setContentAreaFilled(false);

        jButton2.setFont(new java.awt.Font("Verdana", 1, 12)); // NOI18N
        jButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/botonReporte.png"))); // NOI18N
